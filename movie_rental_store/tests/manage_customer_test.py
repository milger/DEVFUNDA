...
class ManageCustomerTest(unittest.TestCase):
    ...
    def test01_create_manage_customer_with_required_data(self):
    ...
    def test02_read_first_name_from_console_and_update_customer_class(self):
    ...
    def test03_read_last_name_from_console_and_update_customer_class(self):
    ...
    def test04_read_date_of_birth_from_console_and_update_customer_class(self):
    ...
    def test05_read_addresses_from_console_and_update_customer_class(self):
    ...
    def test06_read_phones_from_console_and_update_customer_class(self):
    ...
    def test07_read_membership_from_console_and_update_customer_class(self):
    ...
    def test08_read_status_from_console_and_update_customer_class(self):
